...
- **MIN_NOTIONAL_USD** ($5) — positions below this are skipped, not
  emitted as a dust trade the exchange will reject. SoDEX perps min
  notional varies by symbol; $5 is a conservative floor that works
  for all supported markets.

- **MIN_PORTFOLIO_USD** ($25) — below this, the agent can't meaningfully
  allocate any position at Wave 1's 5% per-name cap ($1.25 / position).
